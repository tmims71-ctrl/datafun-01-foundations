...
MY_DEGREE_PROGRAM: Final[str] = "Master of Science in Mathematics"
MY_CURRENT_COURSE_LOAD: Final[int] = 2
MY_AVG_WEEKLY_STUDY_TIME: Final[float] = 15.5
IS_CERTIFIED: Final[bool] = True
MY_PREVIOUS_COURSES: Final[list[str]] = [
    "Abstract Algebra",
    "Number Theory",
    "Elemntary Statictical Concepts",
    "Analytic Geometry",
]
...
def get_summary() -> str:
    ...
    Custom Information:
        ...
        Degree Program: {MY_DEGREE_PROGRAM}
        Current Course Load: {MY_CURRENT_COURSE_LOAD}
        Average Weekly Study Time: {MY_AVG_WEEKLY_STUDY_TIME} hours
        Is Certified: {IS_CERTIFIED}
        Previous Courses: {MY_PREVIOUS_COURSES}
    """
...
def get_statistics() -> str:
    ...
    snowfall_inches: list[float] = [2.5, 3.5, 5.7, 5.5, 6.5]
